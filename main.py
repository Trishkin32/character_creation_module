...
class Character:
    BRIEF_DESC_CHAR_CLASS = 'отважный любитель приключений'  # описание класса
...
warrior = Warrior('Кодослав')  # Создали объект одного из класса наседника
print(warrior)                 # и вызвали метод аттаки)
